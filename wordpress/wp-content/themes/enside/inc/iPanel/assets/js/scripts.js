    ...
    jQuery(document).ready( function( $ ){
        ...
        $('.ipanel-media-remove-button').click( function(){
            $(this).prev().prev('.ipanel-media-uploader-input').val('');
            $(this).next('.ipanel-quick-upload-file').html('').hide();
        });
        ...
        $('body').on( 'click' , '.ipanel-media-upload-button' ,function() {
            ...
            custom_uploader.on('select', function() {
                ...
                _this.next().next(".ipanel-quick-upload-file").html('<img class="ipanel-qup-up-img img" src="'+attachment.url+'"><div class="clr"></div>').show();
