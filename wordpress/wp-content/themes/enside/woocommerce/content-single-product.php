...
if ( defined('DEMO_MODE') && isset($_GET['woocommerce_product_sidebar_position']) ) {
  $enside_theme_options['woocommerce_product_sidebar_position'] = $_GET['woocommerce_product_sidebar_position'];
}

if(isset($enside_theme_options['woocommerce_product_sidebar_position'])) {
	$page_sidebarposition = $enside_theme_options['woocommerce_product_sidebar_position'];
} else {
