 ...
 if ( !class_exists( 'Radium_Theme_Importer' ) ) {
	...
	class Radium_Theme_Importer {
			...
			?>
			 ...
			 <div class="theme-demo-import-items">
				 ...
				 <div class="theme-demo-import-item">
					 ...
					 <a class="theme-live-preview button button-primary" href="http://wp.magnium-themes.com/enside/enside-1/" target="_blank">Live preview</a>
					 </div>
				 </div>
				 ...
				 <div class="theme-demo-import-item">
					 <label>
					 <div class="theme-demo-import-item-title">
					 <input type="radio" name="theme_demo" value="2">Demo 2 - Agency<br>
					 </div>
					 <img src="<?php echo plugin_dir_url( __FILE__ ); ?>../demo-files/2/theme-preview.jpg" alt="Demo site image"/>
					 </label>
					 <div class="theme-demo-import-item-button">
					 <a class="theme-live-preview button button-primary" href="http://wp.magnium-themes.com/enside/enside-2/" target="_blank">Live preview</a>
					 </div>
				 </div>
				 ...
				 <div class="theme-demo-import-item">
					 <label>
					 <div class="theme-demo-import-item-title">
					 <input type="radio" name="theme_demo" value="3">Demo 3 - Company<br>
					 </div>
					 <img src="<?php echo plugin_dir_url( __FILE__ ); ?>../demo-files/3/theme-preview.jpg" alt="Demo site image"/>
					 </label>
					 <div class="theme-demo-import-item-button">
					 <a class="theme-live-preview button button-primary" href="http://wp.magnium-themes.com/enside/enside-3/" target="_blank">Live preview</a>
					 </div>
				 </div>
				 ...
				 <div class="theme-demo-import-item">
					 <label>
					 <div class="theme-demo-import-item-title">
					 <input type="radio" name="theme_demo" value="4">Demo 4 - Landing<br>
					 </div>
					 <img src="<?php echo plugin_dir_url( __FILE__ ); ?>../demo-files/4/theme-preview.jpg" alt="Demo site image"/>
					 </label>
					 <div class="theme-demo-import-item-button">
					 <a class="theme-live-preview button button-primary" href="http://wp.magnium-themes.com/enside/enside-4/" target="_blank">Live preview</a>
					 </div>
				 </div>
				 ...
				 <div class="theme-demo-import-item">
					 <label>
					 <div class="theme-demo-import-item-title">
					 <input type="radio" name="theme_demo" value="5">Demo 5 - Business<br>
					 </div>
					 <img src="<?php echo plugin_dir_url( __FILE__ ); ?>../demo-files/5/theme-preview.jpg" alt="Demo site image"/>
					 </label>
					 <div class="theme-demo-import-item-button">
					 <a class="theme-live-preview button button-primary" href="http://wp.magnium-themes.com/enside/enside-5/" target="_blank">Live preview</a>
					 </div>
				 </div>
				 ...
				 <div class="theme-demo-import-item">
					 <label>
					 <div class="theme-demo-import-item-title">
					 <input type="radio" name="theme_demo" value="6">Demo 6 - Personal<br>
					 </div>
					 <img src="<?php echo plugin_dir_url( __FILE__ ); ?>../demo-files/6/theme-preview.jpg" alt="Demo site image"/>
					 </label>
					 <div class="theme-demo-import-item-button">
					 <a class="theme-live-preview button button-primary" href="http://wp.magnium-themes.com/enside/enside-6/" target="_blank">Live preview</a>
					 </div>
				 </div>
				 ...
				 <div class="theme-demo-import-item">
					 <label>
					 <div class="theme-demo-import-item-title">
					 <input type="radio" name="theme_demo" value="7">Demo 7 - Photography<br>
					 </div>
					 <img src="<?php echo plugin_dir_url( __FILE__ ); ?>../demo-files/7/theme-preview.jpg" alt="Demo site image"/>
					 </label>
					 <div class="theme-demo-import-item-button">
					 <a class="theme-live-preview button button-primary" href="http://wp.magnium-themes.com/enside/enside-7/" target="_blank">Live preview</a>
					 </div>
				 </div>
				 ...
				 <div class="theme-demo-import-item">
					 <label>
					 <div class="theme-demo-import-item-title">
					 <input type="radio" name="theme_demo" value="8">Demo 8 - Classic<br>
					 </div>
					 <img src="<?php echo plugin_dir_url( __FILE__ ); ?>../demo-files/8/theme-preview.jpg" alt="Demo site image"/>
					 </label>
					 <div class="theme-demo-import-item-button">
					 <a class="theme-live-preview button button-primary" href="http://wp.magnium-themes.com/enside/enside-8/" target="_blank">Live preview</a>
					 </div>
				 </div>
				 ...
				 <div class="theme-demo-import-item">
					 <label>
					 <div class="theme-demo-import-item-title">
					 <input type="radio" name="theme_demo" value="9">Demo 9 - Crypto<br>
					 </div>
					 <img src="<?php echo plugin_dir_url( __FILE__ ); ?>../demo-files/9/theme-preview.jpg" alt="Demo site image"/>
					 </label>
					 <div class="theme-demo-import-item-button">
					 <a class="theme-live-preview button button-primary" href="http://wp.magnium-themes.com/enside/enside-9/" target="_blank">Live preview</a>
					 </div>
				  </div>
				 ...
				 <div class="theme-demo-import-item">
					 <label>
					 <div class="theme-demo-import-item-title">
					 <input type="radio" name="theme_demo" value="10">Demo 10 - Product Selector<br>
					 </div>
					 <img src="<?php echo plugin_dir_url( __FILE__ ); ?>../demo-files/10/theme-preview.jpg" alt="Demo site image"/>
					 </label>
					 <div class="theme-demo-import-item-button">
					 <a class="theme-live-preview button button-primary" href="http://wp.magnium-themes.com/enside/enside-10/" target="_blank">Live preview</a>
					 </div>
				 </div>

				 <div class="theme-demo-import-item theme-demo-request-demo-item">
					 <label>
					 <div class="theme-demo-import-item-title">
					Request Theme Demo<br>
					 </div>
					 <img src="<?php echo plugin_dir_url( __FILE__ ); ?>../demo-files/theme-demo-request.jpg" alt="Demo site image"/>
					 </label>
					 <div class="theme-demo-import-item-button">
					 <a class="theme-live-preview button button-secondary" href="http://magniumthemes.com/request-theme-demo/" target="_blank">Request your demo</a>
					 </div>
				 </div>
			 ...
			 if( !empty($this->imported_demos) ) { ?>
			  	...
			  	<div class="import-description" style="background-color: #FAFFFB; margin:10px 0 30px;padding: 5px 30px;color: darkgreen;border: 2px solid #a1d3a2; clear:both; width:auto;">
			  		<p><?php echo wp_kses_post('You already launched demo data import before, but you can import demo content again (for example import just sliders from another demo). Some of your content (menus, posts, etc) can be dublicated if you checked "Content" to be imported. We recommend you to <a href="https://wordpress.org/plugins/wordpress-reset/" target="_blank">reset your WordPress</a> first.'); ?></p>
			  	</div><?php
			   	//return;
	    ...
	    public function demo_installer() {
	        ...
	        <h1>One Click Enside Theme Demo Data import - [T|H|E|M|E]-[D|O|W|N|L|O|A|D|E|D]-[F|R|O|M]-[N|i|T|R|O|G|F|X|.|C|O|M]</h1>
			
			<?php if((get_option( 'enside_license_key_status', false ) == 'activated')&&(!defined('ENVATO_HOSTED_SITE'))): ?>


			<div class="radium-importer-wrap">
		        <div class="theme-important-notice">
			 	<p>Please register your purchase to import theme demos, get themes updates notifications and get access to premium dedicated support. Theme registration is free and will take just 30 seconds.</p>

	          	<a href="themes.php?page=ipanel_ENSIDE_PANEL" class="button button-hero button-primary">Theme registration</a>
	          	<br/><br/>
				</div>
			</div>
			...
			$(document).ready(function() {
				...
				$('.radium-import-start').click(function(){
					...
					$.get( "themes.php?page=radium_demo_installer&import_theme_demo="+theme_demo_value+"&demo_import_content="+demo_import_content+"&demo_import_sliders="+demo_import_sliders+"&demo_import_widgets="+demo_import_widgets+"&demo_import_themeoptions="+demo_import_themeoptions+"&action=demo-data&demononce=<?php echo wp_create_nonce('radium-demo-code'); ?>", function( data ) {
					  $( ".radium-importer-message" ).html( '<div class="theme-important-notice"><p><span style="color: darkgreen;"><strong>Demo data was imported succesfully.</strong></span><br>Any real images that may be imported with demo data are just examples and you do not have legal rights to use these images on your website, you must replace these images with your own.</p></div><h2>What to do next?</h2><div class="theme-important-notice"><p><a class="button-secondary" href="http://magniumthemes.com/go/enside-docs/" target="blank">Read Theme Documentation Guide</a> <a href="admin.php?page=ipanel_ENSIDE_PANEL" class="button-primary">Manage Theme Settings</a> <a href="<?php echo esc_url(get_site_url());?>" target="_blank" class="button-primary">Visit your website frontend</a> </p><p>You can <a class="check-import-log" style="cursor: pointer;">check import log</a> if you think your website looks incorrectly after demo data import.</p><div class="import-log-text" style="display: none;">' + $(data).find(".radium-importer-message").html() + '</div></div>' );
					});
				});
